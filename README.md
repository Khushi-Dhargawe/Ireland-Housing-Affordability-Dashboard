...
This isn't a generic dashboard — it uses official Irish government data for a real national charity. Every visual maps directly to a resource allocation decision for Focus Ireland's prevention and rehousing programmes.
...
Raw dataset not included due to file size. Download directly from CSO DataHub HPA02.
...
|---------|-------|-----------------|
| Highest median price (2024) | Dublin — EUR 475,000 | Priority area for prevention funding |
| Lowest median price (2024) | Donegal — EUR 180,000 | Target for cost-effective acquisitions |
| Price gap | EUR 295,000 between highest and lowest county | Quantifies geographic inequality for advocacy |
| Price trend | U-shaped — fell 2010–2013, rising sharply to 2024 | Policy window identified post-2013 |
| New vs existing | New homes consistently 15–25% more expensive | Focus on existing stock acquisitions |
...
With income data by county I'd calculate a true affordability ratio (price-to-income). With planning permission data I'd correlate supply pipeline against price pressure by region.
